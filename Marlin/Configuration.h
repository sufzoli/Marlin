...
#define STRING_CONFIG_H_AUTHOR "SUF - Anet A8 b0001" // Who made the changes.
...
#define Z_MIN_ENDSTOP_INVERTING ture // set to true to invert the logic of the endstop.
